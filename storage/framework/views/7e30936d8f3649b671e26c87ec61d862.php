        ...
        <div class="inner-body">
            ...
            <div class="card bg-light-transparent">
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-4">
                            <form action="<?php echo e(route('option.add')); ?>" class="formData" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-c" name="option_category" id="option_category" required>
                                        <option>~~ SELECT ~~</option>
                                        <?php $__currentLoopData = $options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $x => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php if(Auth::user()->can('Add Option')): ?>
        ...
        <script>
            $(document).ready(function() {
                ...
                $(document).on('click', '.addSelectOptions', function () {
                    ...
                    $("#optionsForm").attr('action', "<?php echo e(route('option.value_add', ['id' => ':id'])); ?>".replace(':id', id));
                ...
                $(document).on('click', '.modifyOptions', function () {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo e(route('option.value_modify')); ?>",
                        data: {
                            id: id,
                            type: type
                        },
                        ...
                        success: function (response) {
                            if (type == 'edit') {
                                ...
                                $("#optionsForm").attr('action', "<?php echo e(route('option.update_values', ['option_v_id' => ':id'])); ?>".replace(':id', id));
                            }else{
                                notif({
                                    type: response.sts,
                                    msg: response.msg,
                ...
                $(".formData").on('submit', function(e) {
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',
                        success: function(response) {
                            $(".formData").attr('action', "<?php echo e(route('option.add')); ?>");
                ...
                var optionTable = $("#optionTable").DataTable({
                    ...
                    "ajax": {
                        url: "<?php echo e(route('option.load')); ?>", // json datasource
                ...
                $(document).on('click', ".edit", function() {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo e(route('option.get', ['id' => ':id'])); ?>".replace(':id', id),
                        dataType: "json",
                        success: function(response) {
                            $("#saveData").text('Update').addClass('btn-danger').removeClass('btn-primary');
                            $(".formData").attr('action', "<?php echo e(route('option.update', ['id' => ':id'])); ?>".replace(':id', id));
                ...
                $(document).on("click", ".delete", function() {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo e(route('option.delete', ['id' => ':id'])); ?>".replace(':id', id),
                        dataType: "json",
                        success: function(response) {
                            notif({
                                type: response.sts,
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\upwork\quotegen\resources\views/tenant/options.blade.php ENDPATH**/ ?>