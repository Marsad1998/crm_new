...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="inner-body">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="<?php echo e(route('quote.create')); ?>" method="post" id="formData">
                        <div class="row">
                            <div class="col-sm-4">
        ...
        <script>
            $(document).ready(function() {
                ...
                var configTbl = $("#configTbl").DataTable({
                    ...
                    responsive: true,
                    "ajax": {
                        url: "<?php echo e(route('quote.load')); ?>", // json datasource
                ...
                $("#fields").select2({
                    ...
                    ajax: {
                        method: 'post',
                        url: '<?php echo e(route("quote.fields")); ?>',
                        dataType: 'json',
                        delay: 250,
                ...
                $(document).on('click', '.removeRow1', function () {
                    ...
                    if (id != '') {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "<?php echo e(route('quote.delete_config', ['id' => ':id'])); ?>".replace(':id', id),
                            dataType: "json",
                            success: function (response) {
                ...
                $(document).on("click", ".delete", function() {
                    ...
                    $.ajax({
                        type: "POST", 
                        url: "<?php echo e(route('quote.delete', ['id' => ':id'])); ?>".replace(':id', id),
                        dataType: "json",
                        success: function(response) {
                            notif({
                                type: response.sts,
                ...
                $("#category_services").select2({
                    ...
                    ajax: {
                        method: 'post',
                        url: '<?php echo e(route("quote.category")); ?>',
                        dataType: 'json',
                        delay: 250,
                        processResults: function (data) {
                            return {
                ...
                function getData(id) {  
                    $.ajax({
                        type: "POST", 
                        url: "<?php echo e(route('quote.edit', ['id' => ':id'])); ?>".replace(':id', id),
                        dataType: "json",
                        success: function(response) {
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\upwork\monties\resources\views/tenant/quote_config.blade.php ENDPATH**/ ?>