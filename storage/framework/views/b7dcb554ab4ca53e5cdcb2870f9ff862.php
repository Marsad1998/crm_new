    ...
    <div class="container">
        <div class="main-header-left">
            ...
            <a class="main-logo" href="index.html">
                <img src="<?php echo e(global_asset('assets/img/brand/montys-logo.png')); ?>" class="width-137 header-brand-img desktop-logo" alt="logo">
                <!-- <img src="<?php echo e(global_asset('assets/img/brand/logo-light.png')); ?>" class="header-brand-img desktop-logo theme-logo" alt="logo"> -->
            </a>
        </div>
        <div class="main-header-center">
            <div class="responsive-logo">
                <a href="index.html"><img src="<?php echo e(global_asset('assets/img/brand/montys-logo.png')); ?>" class="width-137 mobile-logo" alt="logo"></a>
                <!-- <a href="index.html"><img src="<?php echo e(global_asset('assets/img/brand/logo-light.png')); ?>" class="mobile-logo-dark" alt="logo"></a> -->
            </div>
        </div>
        <div class="main-header-right">
            ...
            <div class="dropdown main-header-notification">
                ...
                <div class="dropdown-menu br-radius-15">
                    ...
                    <div class="main-notification-list">
                        <div class="media new">
                            <div class="main-img-user online"><img alt="avatar" src="<?php echo e(global_asset('assets/img/users/5.jpg')); ?>"></div>
                            <div class="media-body">
                                <p>Congratulate <strong>Olivia James</strong> for New template start</p><span>Oct 15 12:32pm</span>
                            </div>
                        </div>
                        <div class="media">
                            <div class="main-img-user"><img alt="avatar" src="<?php echo e(global_asset('assets/img/users/2.jpg')); ?>"></div>
                            <div class="media-body">
                                <p><strong>Joshua Gray</strong> New Message Received</p><span>Oct 13 02:56am</span>
                            </div>
                        </div>
                        <div class="media">
                            <div class="main-img-user online"><img alt="avatar" src="<?php echo e(global_asset('assets/img/users/3.jpg')); ?>"></div>
                            <div class="media-body">
            ...
            <div class="dropdown main-profile-menu">
                <a class="d-flex" href="">
                    <span class="main-img-user" ><img alt="avatar" src="<?php echo e(global_asset('assets/img/users/1.jpg')); ?>"></span>
                </a>
                <div class="dropdown-menu br-radius-15 cstm-profile-dropdown-menu">
                    <div class="header-navheading">
                        ...
                        <p class="main-notification-text"><?php echo e(auth()->user()->role->name); ?></p>
                    </div>
            ...
            <?php $__currentLoopData = $mains; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $main): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if(empty($main['option'])): ?>
                    <li class="nav-item text-capitalize uno">
                        <a class="nav-link uno-a" href="<?php echo e($main['path']); ?>" cstmname="<?php echo e($main['name']); ?>" cstmParname="false">
                ...
                <?php else: ?>
                    <li class="nav-item text-capitalize uno">
                        <a class="nav-link with-sub uno-a" href="#">
                            <span class="shape1"></span>
                            <span class="shape2"></span>
                            <i class="<?php echo e($main['icon']); ?> sidemenu-icon"></i> <?php echo e($main['name']); ?>
                        ...
                        <ul class="nav-sub br-radius-15">
                            <?php $__currentLoopData = $main['option']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="nav-sub-item <?php echo e($option['access']); ?> link-svgline sec-link-svgline" style="color:black">
                                        <a class="nav-sub-link cstm-nsb" href="<?php echo e($option['path']); ?>" cstmname="<?php echo e($option['name']); ?>" cstmParname="<?php echo e($main['name']); ?>"><?php echo e($option['name']); ?><svg class="link-svgline"><use xlink:href="#svg_line"></use></svg></a>
                                </li>
...
<!--End  Horizonatal menu--><?php /**PATH C:\xampp\htdocs\upwork\quotegen\resources\views/tenant/navbar.blade.php ENDPATH**/ ?>