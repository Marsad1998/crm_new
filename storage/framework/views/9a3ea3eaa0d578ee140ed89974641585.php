                                        ...
                                        <div class="col-md-12 col-lg-6 col-xl-6">
                                            <div class="form-group">
                                                ...
                                                <select name="key_type" id="key_type" class="form-control select2">
                                                    <option value="">Select option</option>
                                                    <?php $__currentLoopData = $keyType; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table class="table">
                        ...
                        <?php $__currentLoopData = $bulkDiscounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $discount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <th scope="row"><?php echo e(($discount->KeyType) ? $discount->KeyType->name : '-'); ?></th>
                                <td><?php echo e($discount->key_number); ?></td>
                                <td><?php echo e($discount->multiplier); ?>%</td>
                                <td>
                                    <?php if($discount->state == 1): ?>
                                ...
                                <td>
                                    <button class="btn btn-primary toggleBtn"  data-id="<?php echo e($discount->id); ?>" type="button">Toggle State</button>
                                </td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <form action="<?php echo e(route("bulk-discounts.create")); ?>" method="post" id="bulkCreate">
                            <?php echo csrf_field(); ?>
                            <tr class="bulk-form">
                                <td>
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $(document).on("click", ".toggleBtn", function (){
                    ...
                    $.ajax({
                        url: "<?php echo e(route('bulk-discounts.toggle')); ?>",
                ...
                function getBulkDiscounts(){
                    $.ajax({
                        url: "<?php echo e(route('bulk-discounts.get')); ?>",
                        data: $(this).serialize(), // Serialize the form data
                        success: function(response) {
                ...
                $(document).on('change', 'select[name=make_1]', function () {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo e(route('price.get-models')); ?>",
                        data: {
                            make_id: data
                        },
                        dataType: "html",
